...
const IntroScreen = ({ onComplete }) => {
  ...
  // CoinFlip dots animation
  const CoinFlipDotVariants = {
  ...
  const backgroundVariants = {
    initial: {
      background:
        'linear-gradient(135deg, rgba(34,173,116,0.02) 0%, rgba(255,255,255,0.8) 100%)',
    },
    animate: {
      background:
        'linear-gradient(135deg, rgba(34,173,116,0.1) 0%, rgba(255,255,255,0.9) 100%)',
      transition: {
        duration: 3,
        repeat: Infinity,
        repeatType: 'reverse',
          ...
          >
            <div className="relative">
              ...
              <div className="w-40 h-40 bg-gradient-to-br from-[#22AD74] to-[#26c582] rounded-xl shadow-lg flex items-center justify-center transform -rotate-12">
                {/* CoinFlip Face - showing a standard 6-face CoinFlip */}
              ...
              >
                ...
                <div className="bg-white/70 p-8 rounded-xl shadow-sm border border-[#22AD74]/10">
                  ...
                  <p className="text-gray-700 text-lg leading-relaxed">
                    ...
                    <strong>absolutely no house edge</strong>. 100% of potential
                    winnings go back to players, giving you better odds than any
                    traditional casino.
                  </p>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-white/70 p-8 rounded-xl shadow-sm border border-[#22AD74]/10">
                  ...
                  <p className="text-gray-700 text-lg leading-relaxed">
                    ...
                    generate truly random and tamper-proof outcomes that can be
                    cryptographically verified by anyone.
                  </p>
                </div>
                ...
                <div className="bg-white/70 p-8 rounded-xl shadow-sm border border-[#22AD74]/10">
                  ...
                  <p className="text-gray-700 text-lg leading-relaxed">
                    ...
                    . No centralized servers are ever involved in determining
                    game outcomes, ensuring complete transparency and fairness.
                  </p>
                </div>
              </motion.div>
              ...
              >
                <ul className="flex flex-col gap-3">
                  ...
                  <li className="flex items-center gap-3 text-left text-lg">
                    ...
                    />
                    <span>
                      <strong>No servers</strong> or centralized infrastructure
                      involved
                    </span>
                  </li>
                </ul>
